            ...
            <div className="main-test-div">
                <div className="Quantity-div">
                    ...
                    <div className="inputs-layout-out">
                        <input type="number" className="inner-input-div" onChange={this.HandleInputValueChange} />
                    <div className="input-select">=</div>
                        <input type="number" className="inner-input-div" defaultValue={this.state.convertedValue } />
                    </div>
                    <div className="app-button">
                        <button className="submit" onClick={this.onSubmit}>Submit</button> </div>
               </div>
            </div>
        )
